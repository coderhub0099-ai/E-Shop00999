      ...
      <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16 bg-sleek-pattern relative z-10">
        ...
        <section className="bg-emerald-50 rounded-3xl p-8 sm:p-10 md:p-12 flex flex-col md:flex-row items-center justify-between border border-emerald-100 shadow-sm gap-8">
          ...
          <div className="max-w-xl text-center md:text-left flex-1">
            <span className="inline-block px-3 py-1 bg-emerald-200/50 text-emerald-800 text-[10px] font-bold uppercase rounded-full mb-4 tracking-wide shadow-2xs">
            ...
            <p className="text-slate-650 mb-6 font-normal text-sm sm:text-base leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 py-1 justify-center md:justify-start">
              <button
                ...
                className="bg-slate-900 text-white px-8 py-3 rounded-xl font-bold shadow-md shadow-slate-200 hover:bg-slate-805 transition-all cursor-pointer flex items-center justify-center gap-2 hover:translate-y-[-1px] active:translate-y-[0.5px]"
                id="hero-see-menu"
              >
              ...
              {/* Secure Hours badge */}
              <div className="flex items-center gap-2 text-slate-500 font-medium text-xs sm:text-sm bg-white/70 backdrop-blur-xs px-4 py-2 rounded-xl border border-slate-100 shadow-2xs">
          ...
          {/* Right showcase: Beautiful, clean glassmorphic tile for branding original vector logo */}
          <div className="flex-shrink-0 relative h-48 w-48 sm:h-56 sm:w-56 aspect-square flex items-center justify-center bg-white rounded-3xl shadow-xl border border-white/80 overflow-hidden group">
            ...
            <motion.div
              ...
              className="w-36 h-36 select-none relative z-10 transition-transform duration-350 group-hover:scale-110"
            >
