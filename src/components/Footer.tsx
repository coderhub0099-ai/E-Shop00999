      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-4 flex flex-col gap-4">
          <div className="flex items-center gap-2.5">
            <div className="bg-slate-800 border border-slate-750 p-1 rounded-lg shadow-sm">
              <QuirkyFruityLogo className="w-7 h-7" />
            </div>
            <span className="text-xl font-bold tracking-tight text-emerald-450 capitalize">
              {siteSettings.websiteName || 'quirky-fruity'}
            </span>
          </div>
          <p className="text-xs text-slate-350 font-normal leading-relaxed max-w-sm">
        ...
        <div className="md:col-span-4 flex flex-col gap-3">
          ...
          <ul className="space-y-2 text-xs text-slate-350 font-medium uppercase">
            ...
            <li>
              <a href="/admin" className="hover:text-emerald-400 text-slate-450 font-bold transition-colors flex items-center gap-1.5">
                ● 🔒 ADMIN CONSOLE
              </a>
            </li>
          </ul>
        ...
        <div className="md:col-span-4 flex flex-col gap-4">
          ...
          <ul className="space-y-3 text-xs text-slate-350 font-medium">
            <li className="flex items-start gap-2.5">
              <MapPin className="w-4 h-4 text-emerald-450 flex-shrink-0" />
              <span>{siteSettings.contactAddress || '42 Orchard Lane, Gulshan, Dhaka, Bangladesh'}</span>
            </li>
            <li className="flex items-center gap-2.5">
              <Phone className="w-4 h-4 text-emerald-450 flex-shrink-0" />
              <span>{siteSettings.contactPhone || '+880 1711-223344'}</span>
            </li>
            <li className="flex items-center gap-2.5">
              <Mail className="w-4 h-4 text-emerald-450 flex-shrink-0" />
